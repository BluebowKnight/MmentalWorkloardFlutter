        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                //Average Rating
                Text('Average Rating: ${context.watch<WorkloadDataProvider>().rangeInfo.averageMWLRating}',style: TextStyle(color: Theme.of(context).colorScheme.primary,fontWeight: FontWeight.w500,fontSize: 12.0,letterSpacing: 0.1,),),
                ...
                //Average Duration
                Text('Average Duration: ${context.watch<WorkloadDataProvider>().rangeInfo.averageDuration}',style: TextStyle(color: Theme.of(context).colorScheme.primary,fontWeight: FontWeight.w500,fontSize: 12.0,letterSpacing: 0.1,),),
              ],
            ),
          ),
              ...
              child: SfCartesianChart(
                ...
                series: <BubbleSeries<ChartData, num>>[
                  BubbleSeries<ChartData,num>(
                    dataSource: generateBubbles(context.watch<WorkloadDataProvider>().rangeRating),
