...
import 'package:prototype/bloc/java_analyzer/java_method_provider.dart';
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_)=>WorkloadDataProvider()),
        ChangeNotifierProvider(create: (_)=>SleepDataProvider()),
     ],
     child: JavaMethod_Provider(child: const MyApp()),
    )
  );
}
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.highContrastLight(primary: const Color.fromARGB(255, 75, 83, 120)),
        useMaterial3: true,
      ),
      home: HomePage(),
    );
